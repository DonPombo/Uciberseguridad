...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        debugPrint('Intentando login con Supabase...');
        ...
        if (user != null) {
          debugPrint('Login exitoso. ID de usuario: ${user.id}');
          if (mounted) {
            debugPrint('Llamando callback de login exitoso');
            widget.onLoginSuccess(user);
          }
        } else {
          debugPrint('Error: usuario es null después del login');
        }
      } catch (e) {
